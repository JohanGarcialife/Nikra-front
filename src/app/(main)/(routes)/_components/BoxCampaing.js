...
export default function BoxCampaing(props) {
  ...
  return (
    <div>
      <div className="relative w-full h-fit  bg-white/30 border-t-4 border-b-4 border-primary border-l-0 py-2 px-5 border-r-0 flex justify-center items-center overflow-hidden rounded-lg">
