...
export default function MainMenuBar(props) {
  ...
  return (
    <>
      <div className="grid grid-cols-3 w-full  h-full bg-white rounded-xl  py-2 px-3  shadow s my-5 ">
        ...
        <div
          ...
          className="flex  flex-col items-center justify-center text-primary flex-1"
        >
          {/* .item: flex-col, centrado, flex-1 (distribuye el espacio) */}

          <Image width={30} height={30} src={"/icono-legal.svg"} alt={"menu"} />
        ...
        <div className="flex  flex-col items-center justify-center text-primary flex-1">
          {/* .item: flex-col, centrado, flex-1 (distribuye el espacio) */}
